...
//        String[] books = {"Handmaid's Tale", "Slenderman", "The Loy Luck Club", "East if Eden", "The Leaning Tower"};
        String[] books = new String[5];
        books[0] = "Handmaid's Tale";
        books[1] = "Slenderman";
        books[2] = "The Loy Luck Club";
        books[3] = "East if Eden";
        books[4] = "The Leaning Tower";
