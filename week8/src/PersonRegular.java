public class PersonRegular {
    ...
    public static void main(String[] args) {
        ...
        String firstPersonCar = "Colkswagon Bug";
        ...
        // logic in the car insurance industry - if you have traffic tickets DUIs other traffic violations
        // you will be be paying more for your insurance
